...
namespace BelowZeroServer
{
    public class Packet : IDisposable
    {
        ...
        public byte ReadByte(bool _moveReadPos = true)
        {
            ...
            {
                Logger.Log("Could not read value of type 'byte'!");
        ...
        public short ReadShort(bool _moveReadPos = true)
        {
            ...
            {
                Logger.Log("Could not read value of type 'short'!");
        ...
        public int ReadInt(bool _moveReadPos = true)
        {
            ...
            {
                Logger.Log("Could not read value of type 'int'!");
        ...
        public long ReadLong(bool _moveReadPos = true)
        {
            ...
            {
                Logger.Log("Could not read value of type 'long'!");
        ...
        public float ReadFloat(bool _moveReadPos = true)
        {
            ...
            {
                Logger.Log("Could not read value of type 'float'!");
        ...
        public bool ReadBool(bool _moveReadPos = true)
        {
            ...
            {
                Logger.Log("Could not read value of type 'bool'!");
        ...
        public string ReadString(bool _moveReadPos = true)
        {
            ...
            {
                Logger.Log("Could not read value of type 'String'!");
